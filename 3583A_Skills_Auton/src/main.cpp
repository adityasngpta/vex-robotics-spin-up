...
void intakeStart(double speed = 100)
{
...
void forwardDist(double stoppingDist)
{
  double dist = stoppingDist + 1;

  driveTrain.drive(fwd, 50, velocityUnits::pct);
...
void prerequisites()
{
leftDriveA.resetRotation();
leftDriveB.resetRotation();
leftDriveC.resetRotation();
rightDriveA.resetRotation();
rightDriveB.resetRotation();
rightDriveC.resetRotation();
...
void autonomous()
{
  ...
  driveTrain.drive(fwd, 5, velocityUnits::rpm);
